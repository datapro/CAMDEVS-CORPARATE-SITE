<footer id="footer">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <a class="footer-logo" href="index.html"><img src="{{asset('assets/images/log.png')}}" alt="logo" style="width: 737px;"></a>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever. </p>
                    <h5>Sign Up Our Newsletter</h5>
                    <form class="newsletter-form">
                    <div class="f-field"><input name="fname" type="text" required placeholder="Enter Your Email Address"></div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <ul class="footer-social clearfix">
                        ...
                        <li class="flicker"><a href="#" target="_blank"><i class="fab fa-flickr"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="section-inner footer-bottom">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
               <p>Copyright © 2024 CAMDEV - All rights reserved.</p>
            </div>
