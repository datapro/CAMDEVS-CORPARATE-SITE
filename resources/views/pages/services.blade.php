...
<main>
    ...
    <!-- services section -->
    <section id="our-services" class="grey-bg">
     <div class="section-inner">
      <div class="container">
       ...
       <div class="col-lg-4 col-md-6">
        <div class="service-box">
          <a href="service-details.html"><div class="service-img" style="background:url({{asset('assets/images/service-img7.jpg')}}) no-repeat center center; background-size:cover"></div></a>
          <div class="service-content">
           <h5><a href="service-details.html">Bootstrap Framework</a></h5>
           <p>Lorem ipsum dolor sit amet, consec teturadipsi cing elit. Nobis commodi esse aliquam eligend reprehenderit, numquam a odio. <a href="service-details.html">Read More</a></p>
           <div class="service-info clearfix">
       ...
       <div class="col-lg-4 col-md-6">
        <div class="service-box">
          <a href="service-details.html"><div class="service-img" style="background:url({{asset('assets/images/service-img8.jpg')}}) no-repeat center center; background-size:cover"></div></a>
          <div class="service-content">
           <h5><a href="service-details.html">Fully Responsive</a></h5>
           <p>Lorem ipsum dolor sit amet, consec teturadipsi cing elit. Nobis commodi esse aliquam eligend reprehenderit, numquam a odio. <a href="service-details.html">Read More</a></p>
           <div class="service-info clearfix">
       ...
       <div class="col-lg-4 col-md-6">
        <div class="service-box">
          <a href="service-details.html"><div class="service-img" style="background:url({{asset('assets/images/service-img9.jpg')}}) no-repeat center center; background-size:cover"></div></a>
          <div class="service-content">
           <h5><a href="service-details.html">Detailed Documentation</a></h5>
           <p>Lorem ipsum dolor sit amet, consec teturadipsi cing elit. Nobis commodi esse aliquam eligend reprehenderit, numquam a odio. <a href="service-details.html">Read More</a></p>
           <div class="service-info clearfix">
