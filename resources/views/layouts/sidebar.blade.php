<div class="pcoded-main-container">
    ...
    <li class>
    <a href="{{url('/feeding')}}" class="waves-effect waves-dark">
    <span class="pcoded-micon">
    <i class="feather icon-menu"></i>
    </span>
    <span class="pcoded-mtext">Feeding Applicants</span>
    <span class="pcoded-badge label label-warning"></span>
    </a>
    </li>
    <li class>
    ...
    <span class="pcoded-mtext">Business Applicants</span>
    <span class="pcoded-badge label label-warning"></span>
    </a>
    </li>
   
    <li class>
    <a href="{{url('/scholarship')}}" class="waves-effect waves-dark">
    <span class="pcoded-micon">
    <i class="feather icon-menu"></i>
    </span>
    <span class="pcoded-mtext">Scholarship Aplicants</span>
    <span class="pcoded-badge label label-warning"></span>
    </a>
    </li>
    <li class>
    <a href="{{url('/agro')}}" class="waves-effect waves-dark">
    <span class="pcoded-micon">
    <i class="feather icon-menu"></i>
    </span>
    <span class="pcoded-mtext">Small Scale Farmers Aplicants</span>
    <span class="pcoded-badge label label-warning"></span>
    </a>
    </li>
    <li class>
    ...
    <span class="pcoded-mtext">Skill Acquisition Applicant</span>
    <span class="pcoded-badge label label-warning"></span>
    </a>
    </li>
